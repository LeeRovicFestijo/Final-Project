                            ...
                            <div class="block-content collapse in">
								...
								<table cellpadding="0" cellspacing="0" border="0" class="table" id="">
										<thead>
												...
												<th>Quiz Title</th>
												<th>Description</th>
												<th>Recommended Quiz Time (In Minutes)</th>
												<th>Student Quiz Time (In Seconds)</th>
												<th></th>
												</tr>
										</thead>
										<tbody>
                              		<?php
										...
										if (isset($row1['grade'])) {
											...
											$grade = null; // set a default value if the key doesn't exist
										}
										if (isset($row1['student_quiz_time'])) {
											$student_quiz_time = $row1['student_quiz_time'];
										} else {
											$student_quiz_time = null; // set a default value if the key doesn't exist
										}
									?>          
										<?php if ($grade ==""){
										...
										<tr>                     
										 ...
										 <td><?php  echo $student_quiz_time; ?></td>                                     
                                         <td width="200">
